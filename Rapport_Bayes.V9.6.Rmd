...
13  | Tx_Acc.brt_bac1e | taux_acces_brut_premiere_bac 
14  | Tx_Acc.att_bac1e | taux_acces_attendu_premiere_bac
15  | Tx_Acc.att_bac2e | taux_acces_attendu_seconde_bac
...
Le modèle n'incluant que a variable N°15 *taux_acces_attendu_premiere_bac* a une proba beaucoup plus importante (facteur 10). Par ailleurs elle est aussi présente dans presque tous les modèles alternatifs. On remarque aussi la variable N°17: *taux_reussite_attendu_total_series*. 
...
summary(reg.math)
```
On retouve en gros les mêmes variables significatives que dans le modèle de regression Bayésienne. La variable N°6 et dans une moindre mesure la variable N°5.
...
On trouve des résultats comparable en particulier pour la significativité de la variable N°6: (Tx_Suc.brt_s) *taux_reussite_attendu_serie_s*.       
