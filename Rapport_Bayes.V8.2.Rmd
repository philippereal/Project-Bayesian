...
summary(reg.lm)
```
On a "éliminé" l'intercept en centrant ou sinon avec la formule: y~X-1 
...
#X[,1:4]
X_restreint = cbind(1,X[,"taux_reussite_attendu_serie_l"],X[,"taux_acces_attendu_premiere_bac"],X[,"taux_acces_brut_seconde_bac"])
logprob3 = c(
...
### Choix des covariables à l'aide des Bayes factors
