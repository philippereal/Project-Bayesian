...
```{r include=FALSE}
model <- stan_glm(Barre ~ . -code_etablissement -etablissement -Matiere -ville -dept - commune, data=dataMutations_d)
```
...
* Test d'hypothèse $H_0: \beta_i=\beta_j=0$
...
gamma = matrix(F, nrow = niter, ncol = 17)
